...
import { BellRing, BookOpen, CheckCircle, ClipboardType, File, Lock, PaperclipIcon, PuzzleIcon } from "lucide-react";
...
export const CourseSidebarAnnouncement = ({
  sectionId,
  label,
  courseId,
  section,
  ...
  const onClick = () => {
    router.push(`/course-enrolled/${courseId}/annoucement`);
  };
  return (
    <button
      onClick={onClick}
