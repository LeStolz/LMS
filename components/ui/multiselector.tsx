...
type MultiSelectorProps = {
  ...
  onValuesChange: (value: { name: string; value: string }[]) => void;
  loop?: boolean;
  inputValue: string;
...
interface MultiSelectContextProps {
  ...
  onValueChange: (value: { name: string; value: string }) => void;
  open: boolean;
...
const MultiSelector = ({
  ...
  const onValueChangeHandler = useCallback(
    (val: { name: string; value: string }) => {
      if (value.find((item) => item.value == val.value)) {
...
const MultiSelectorItem = forwardRef<
  ...
  { value: string; name: string } & React.ComponentPropsWithoutRef<
